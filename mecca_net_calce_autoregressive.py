...
class TrainConfig:
    ...
    dropout_rate: float = 0.02971920249773558
    lr: float = 0.00013614461291564545
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--kan-hidden-mult", type=int, default=2)
    parser.add_argument("--dropout-rate", type=float, default=0.02971920249773558)
    parser.add_argument("--lr", type=float, default=0.00013614461291564545)
...
def main() -> None:
    ...
    folds = leave_one_out_with_validation("CALCE", battery_names(battery))
